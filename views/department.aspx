...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div id="breadCrum"><h1>Master > Department</h1></div>
        ...
        <div class="tabbable contentbox" id="tabContent"> 
            ...
            <ItemTemplate>
                ...
                <tr ondblclick="updateRow(<%#Eval("deptID") %>, '<%#Eval("deptName") %>', '<%#Eval("description ") %>', '<%#Eval("bgColor") %>', '<%#Eval("textColor") %>', '<%#Eval("costCenter") %>', '<%#Eval("saleAcct") %>', '<%#Eval("purchaseAcct") %>') ;
                                ...
                                $('#filterMarker').html('<%# Eval("deptName") %>');
                ">
                    <td>
                ...
                <div class="tab-pane" id="tab2">
                   ...
                   <div id="department" class="row-fluid">
                    <div class="span6">
                        <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="deptName" type="text" placeholder="Department Name" class="span2"  />
