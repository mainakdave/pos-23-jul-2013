...
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#menu .nav li#taxGroup").addClass("active");
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div id="breadCrum"><h1>Master > Tax Group</h1></div>
          ...
          <div class="tab-content">
                ...
                <ContentTemplate>
                    ...
                    <div id="searchArea">
                        <asp:DropDownList id="searchBy" runat="server" AutoPostBack="false">
                            <asp:ListItem Value="taxGroupName" Text="Tax Group Name"></asp:ListItem>
                            <asp:ListItem Value="taxGroupID" Text="Tax Group ID"></asp:ListItem>
                        </asp:DropDownList>
            ...
            <LayoutTemplate >
                <table class="table table-condensed" id="dataRows">
                    <tr>
                        <th>Tax Group ID</th>
                        <th colspan="2">Tax Group Name</th>
                    </tr>
            ...
            <ItemTemplate>
                <tr ondblclick="updateRow(<%#Eval("taxGroupID") %>, '<%#Eval("country") %>', '<%#Eval("state") %>', '<%#Eval("city") %>', '<%#Eval("reference") %>', '<%#Eval("description ") %>', '<%#Eval("category") %>', '<%#Eval("comment") %>', <%#Eval("serviceTypeID") %>, '<%#Eval("inclusive") %>', '<%#Eval("line") %>', <%#Eval("taxTypeID") %>, '<%#Eval("isPerAmount") %>', <%#Eval("amount") %>, <%#Eval("percentage") %>, '<%#Eval("isExempt") %>', '<%#Eval("afterDiscount") %>', '<%#Eval("afterLine") %>');
                    ...
                    <div class="pagination">
                        <asp:DataPager ID="DataPager" runat="server" PagedControlID="lstvTaxGroup" 
            ...
            <div class="tab-pane" id="tab2">
                ...
                <form class="navbar-form pull-left" id="taxGroupForm" action="taxGroup.aspx">
                    ...
                    <div id="taxGroup" class="row-fluid">
                    <div class="span6">
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><asp:CheckBox ID="inclusive" runat="server" class="span2" /></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><asp:CheckBox ID="isPerAmount" runat="server" class="span2" /></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><asp:CheckBox ID="isExempt" runat="server" class="span2" /></td>
                    </tr>

                    <tr>
                        <td><label>After Discount</label></td>
                        <td><asp:CheckBox ID="afterDiscount" runat="server" class="span2" /></td>
                    </tr>

                    <tr>
                        <td><label>After Line</label></td>
                        <td><asp:CheckBox ID="afterLine" runat="server" class="span2" /></td>
                    </tr>
